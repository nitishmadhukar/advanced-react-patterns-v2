...
class Toggle extends React.Component {
  ...
  static Off = (props) => (props.on ? null : <div>{props.children}</div>);
  ...
  render() {
    ...
    return React.Children.map(this.props.children, (child) => (React.cloneElement(child, {on: this.state.on, toggle: this.toggle})));
  }
}
